          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="glass border-none max-w-lg">
              ...
              <div className="grid gap-4">
                <div>
                  <Label>Name</Label>
                  <Input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Sunrise Apartments – Flat 302" />
                </div>
                <div>
                  <Label>Address</Label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <Input value={form.tenantContact} onChange={(e) => setForm({ ...form, tenantContact: e.target.value })} />
                  </div>
                </div>
              </div>
              <DialogFooter>
                <Button variant="ghost" onClick={() => setOpen(false)}>Cancel</Button>
                <Button className="btn-brand" onClick={create}>Add</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        }
